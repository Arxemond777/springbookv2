package ch4_detailed_configure_spring.page_130_bean_init;
...
public class SimpleBean {
    ...
    public static void main(String[] args) {
        ...
        ctx.load("classpath:META-INF/spring/ch4_detailed_configure_spring/page_130_bean_init/app-context-xml.xml");
        ctx.refresh();
