...
//        return namedParameterJdbcTemplate.query(sql, new ContactWithDetailExtractor()); //Без лямбды
        return namedParameterJdbcTemplate.query(sql, (rs) -> {
            ...
            while (rs.next()) {
                ...
                if (contactTelDetailId > 0) {
                    ...
                    contact.getContactTelDetails().add(contactTelDetail); //TODO если есть связь, то хуячим
                }
            }
